 ...
 *
 */
public class TestExceedparamCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected ExceedparamService service;
    ...
    private static Exceedparam mod =new Exceedparam();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/param/exceedparam/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    Exceedparam m2 = service.get(id);
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<Exceedparam> page = new Page<>();
        Exceedparam m1 = new Exceedparam();
    ...
    public void testEfind() {
        Exceedparam m1 = new Exceedparam();
        List<Exceedparam> list = service.find(m1);
    ...
    public void testGupdate() {
        Exceedparam m1 = service.get(String.valueOf(id));
