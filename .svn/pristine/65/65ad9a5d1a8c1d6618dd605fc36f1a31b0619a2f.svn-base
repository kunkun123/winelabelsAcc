...
<h3>酒标超期预警</h3>
			...
			<table class="">
	            ...
	            <tr class="">
	                		<td class=" " style="width:26%;vertical-align: middle;">
                                <label class="bolder blue control-label "  for="serialSearch">统一社会信用代码：</label>
                             
                                <input name="search" style="width:50%" id="creditSearch" type="text"  class="form-control"/>
                            </td>
                            <td  class=" " style="width:23%;vertical-align: middle">
                                <label class="bolder control-label  blue" for="productidSearch">酒标申领企业：</label>
                            	<input name="search" style="width:55%" id="entSearch" type="text" class="form-control"/>
                            </td>
                             
                            <td  class=" " style="width:48%;vertical-align: middle;">
                                <label class="bolder control-label  blue" for="productidSearch"> 酒标超期预警项 ：</label>
                            
                                 <input name="status" id="status" type="radio" class="form-control" value="1" checked/>申请后长期不使用
                                  <input name="status" id="status" type="radio" class="form-control" value="2"/>使用后长期不流转
                                   <input name="status" id="status" type="radio" class="form-control" value="3"/>流转后长期不核销
...
<script type="text/javascript">
    ...
    function operateFormatter(value,row,index) {
        return[
          "<button class='btn btn-link' href='javascript:void(0)' onclick='view()'>"+row.total+"</button>"
        ].join('')
