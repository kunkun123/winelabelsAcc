package org.gecko.framework.test.param;
...
/**
 *
 * TestFinishtaxcontrolCase
 * Finishtaxcontrol测试用例
 * @author Gecko.Platform
 *
 */
public class TestFinishtaxcontrolCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected FinishtaxcontrolService service;
    ...
    private static Finishtaxcontrol mod =new Finishtaxcontrol();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/param/finishtaxcontrol/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    Finishtaxcontrol m2 = service.get(id);
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<Finishtaxcontrol> page = new Page<>();
        Finishtaxcontrol m1 = new Finishtaxcontrol();
    ...
    public void testEfind() {
        Finishtaxcontrol m1 = new Finishtaxcontrol();
        List<Finishtaxcontrol> list = service.find(m1);
    ...
    public void testGupdate() {
        Finishtaxcontrol m1 = service.get(String.valueOf(id));
