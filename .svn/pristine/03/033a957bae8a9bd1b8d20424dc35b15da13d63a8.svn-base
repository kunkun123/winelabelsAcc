...
<div class="error-container">
    <div class="well">
        <h1 class="grey lighter smaller">
				<span class="bigger-125"> <i class="icon-warning-sign icon-animated-wrench" style="color: #fee188"></i> 404
				</span>Error
        </h1>
        <hr>
        <!--  -->
        ...
        <div>
            ...
            <ul class="list-unstyled spaced inline bigger-110 margin-15" style="font-family: 'Open Sans';">
                <li><i class="icon-hand-right blue icon-animated-wrench"></i> 可能我们的页面和系统正在升级或者维护</li>
                <li><i class="icon-hand-right blue icon-animated-wrench"></i> 可能该网页已经被删除</li>
                <li><i class="icon-hand-right blue icon-animated-wrench"></i> 可能地址是错误的</li>
        ...
        <div class="space"></div>
        <div class="center">
            <a class="btn btn-grey" href="javascript:location.reload();"> <i class="icon-refresh"></i> 刷新页面
            </a>
        </div>
    </div>
</div>
