...
/**
 *
 * TestNeedtaxcontrolCase
 * Needtaxcontrol测试用例
 * @author Gecko.Platform
 *
 */
public class TestNeedtaxcontrolCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected NeedtaxcontrolService service;
    ...
    private static Needtaxcontrol mod =new Needtaxcontrol();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/param/needtaxcontrol/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    Needtaxcontrol m2 = service.get(id);
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<Needtaxcontrol> page = new Page<>();
        Needtaxcontrol m1 = new Needtaxcontrol();
    ...
    public void testEfind() {
        Needtaxcontrol m1 = new Needtaxcontrol();
        List<Needtaxcontrol> list = service.find(m1);
    ...
    public void testGupdate() {
        Needtaxcontrol m1 = service.get(String.valueOf(id));
