...
public class TestPubEnttypeCase extends GeckoTestCase {
    ...
    public void testlog4j() {
    	PropertyConfigurator.configure(PropertyConfigurator.class.getResourceAsStream("D:\\Workspaces\\MyEclipse 2017 CI\\wineLabelsAcc\\src\\main\resources\\log4j.properties")); 
    }
}
