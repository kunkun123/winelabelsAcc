package org.gecko.framework.test.exception;
 ...
 *
 */
public class TestAlExceptionCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected AlExceptionService service;
    ...
    private static AlException mod =new AlException();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/exception/alexception/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    AlException m2 = service.get(id);
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<AlException> page = new Page<>();
        AlException m1 = new AlException();
    ...
    public void testEfind() {
        AlException m1 = new AlException();
        List<AlException> list = service.find(m1);
    ...
    public void testGupdate() {
        AlException m1 = service.get(String.valueOf(id));
