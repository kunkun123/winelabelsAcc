...
/**
 *
 * TestEntApplicationCase
 * EntApplication测试用例
 * @author Gecko.Platform
 *
 */
public class TestEntApplicationCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected EntApplicationService service;
    ...
    private static EntApplication mod =new EntApplication();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/ent/entapplication/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    EntApplication m2 = service.get(id);
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<EntApplication> page = new Page<>();
        EntApplication m1 = new EntApplication();
    ...
    public void testEfind() {
        EntApplication m1 = new EntApplication();
        List<EntApplication> list = service.find(m1);
    ...
    public void testGupdate() {
        EntApplication m1 = service.get(String.valueOf(id));
