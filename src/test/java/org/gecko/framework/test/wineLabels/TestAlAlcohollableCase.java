...
/**
 *
 * TestAlAlcohollableCase
 * AlAlcohollable测试用例
 * @author Gecko.Platform
 *
 */
public class TestAlAlcohollableCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected AlAlcohollableService service;
    ...
    private static AlAlcohollable mod =new AlAlcohollable();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/wineLabels/alalcohollable/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    AlAlcohollable m2 = service.get(id);
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<AlAlcohollable> page = new Page<>();
        AlAlcohollable m1 = new AlAlcohollable();
    ...
    public void testEfind() {
        AlAlcohollable m1 = new AlAlcohollable();
        List<AlAlcohollable> list = service.find(m1);
    ...
    public void testGupdate() {
        AlAlcohollable m1 = service.get(String.valueOf(id));
