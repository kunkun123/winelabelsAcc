...
/**
 *
 * TestAlCirculationCase
 * AlCirculation测试用例
 * @author Gecko.Platform
 *
 */
public class TestAlCirculationCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected AlCirculationService service;
    ...
    private static AlCirculation mod =new AlCirculation();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/wineLabels/alcirculation/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    AlCirculation m2 = service.get(id);
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<AlCirculation> page = new Page<>();
        AlCirculation m1 = new AlCirculation();
    ...
    public void testEfind() {
        AlCirculation m1 = new AlCirculation();
        List<AlCirculation> list = service.find(m1);
    ...
    public void testGupdate() {
        AlCirculation m1 = service.get(String.valueOf(id));
