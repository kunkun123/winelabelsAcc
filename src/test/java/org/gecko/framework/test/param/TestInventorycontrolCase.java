...
/**
 *
 * TestInventorycontrolCase
 * Inventorycontrol测试用例
 * @author Gecko.Platform
 *
 */
public class TestInventorycontrolCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected InventorycontrolService service;
    ...
    private static Inventorycontrol mod =new Inventorycontrol();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/param/inventorycontrol/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    Inventorycontrol m2 = service.get(id);
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<Inventorycontrol> page = new Page<>();
        Inventorycontrol m1 = new Inventorycontrol();
    ...
    public void testEfind() {
        Inventorycontrol m1 = new Inventorycontrol();
        List<Inventorycontrol> list = service.find(m1);
    ...
    public void testGupdate() {
        Inventorycontrol m1 = service.get(String.valueOf(id));
