...
/**
 *
 * TestExceedcontrolCase
 * Exceedcontrol测试用例
 * @author Gecko.Platform
 *
 */
public class TestExceedcontrolCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected ExceedcontrolService service;
    ...
    private static Exceedcontrol mod =new Exceedcontrol();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/param/exceedcontrol/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    Exceedcontrol m2 = service.get(id);
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<Exceedcontrol> page = new Page<>();
        Exceedcontrol m1 = new Exceedcontrol();
    ...
    public void testEfind() {
        Exceedcontrol m1 = new Exceedcontrol();
        List<Exceedcontrol> list = service.find(m1);
    ...
    public void testGupdate() {
        Exceedcontrol m1 = service.get(String.valueOf(id));
