...
/**
 *
 * TestPubBaseinfoSysdeptCase
 * PubBaseinfoSysdept测试用例
 * @author Gecko.Platform
 *
 */
public class TestPubBaseinfoSysdeptCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected PubBaseinfoSysdeptService service;
    ...
    private static PubBaseinfoSysdept mod =new PubBaseinfoSysdept();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/pubdata/pubbaseinfosysdept/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    PubBaseinfoSysdept m2 = service.get(String.valueOf(id));
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<PubBaseinfoSysdept> page = new Page<>();
        PubBaseinfoSysdept m1 = new PubBaseinfoSysdept();
    ...
    public void testEfind() {
        PubBaseinfoSysdept m1 = new PubBaseinfoSysdept();
        List<PubBaseinfoSysdept> list = service.find(m1);
    ...
    public void testGupdate() {
        PubBaseinfoSysdept m1 = service.get(String.valueOf(id));
