...
/**
 *
 * TestPubBaseinfoSysunitCase
 * PubBaseinfoSysunit测试用例
 * @author Gecko.Platform
 *
 */
public class TestPubBaseinfoSysunitCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected PubBaseinfoSysunitService service;
    ...
    private static PubBaseinfoSysunit mod =new PubBaseinfoSysunit();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/pubdata/pubbaseinfosysunit/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    PubBaseinfoSysunit m2 = service.get(String.valueOf(id));
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<PubBaseinfoSysunit> page = new Page<>();
        PubBaseinfoSysunit m1 = new PubBaseinfoSysunit();
    ...
    public void testEfind() {
        PubBaseinfoSysunit m1 = new PubBaseinfoSysunit();
        List<PubBaseinfoSysunit> list = service.find(m1);
    ...
    public void testGupdate() {
        PubBaseinfoSysunit m1 = service.get(String.valueOf(id));
