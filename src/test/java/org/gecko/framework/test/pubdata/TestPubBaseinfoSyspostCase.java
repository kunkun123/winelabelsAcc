...
/**
 *
 * TestPubBaseinfoSyspostCase
 * PubBaseinfoSyspost测试用例
 * @author Gecko.Platform
 *
 */
public class TestPubBaseinfoSyspostCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected PubBaseinfoSyspostService service;
    ...
    private static PubBaseinfoSyspost mod =new PubBaseinfoSyspost();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/pubdata/pubbaseinfosyspost/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    PubBaseinfoSyspost m2 = service.get(String.valueOf(id));
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<PubBaseinfoSyspost> page = new Page<>();
        PubBaseinfoSyspost m1 = new PubBaseinfoSyspost();
    ...
    public void testEfind() {
        PubBaseinfoSyspost m1 = new PubBaseinfoSyspost();
        List<PubBaseinfoSyspost> list = service.find(m1);
    ...
    public void testGupdate() {
        PubBaseinfoSyspost m1 = service.get(String.valueOf(id));
