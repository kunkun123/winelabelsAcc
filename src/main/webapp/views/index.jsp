        ...
        <ul class="nav nav-list submenu " id="submenu">
            ...
            <li class="">
                ...
                <ul class="submenu">
                    ...
                    <li class=""><a
                            href="javascript:clickMenu('entList')"> <i
                            class="menu-icon fa fa-caret-right"></i> 企业列表
                    </a> <b class="arrow"></b></li>
                    <li class=""><a
                            href="javascript:clickMenu('entAuditList')"> <i
                            class="menu-icon fa fa-caret-right"></i> 注册审核
                    </a> <b class="arrow"></b></li>
                </ul></li>
            <li class="">
                    <a href="#" class="dropdown-toggle">
                    ...
                    <ul class="submenu">
						...
						<li class=""><a
							href="javascript:clickMenu('wineLableAudit')"> <i
								class="menu-icon fa fa-caret-right"></i> 申领审核
						</a> <b class="arrow"></b></li>
						<li class=""><a
							href="javascript:clickMenu('wineLableManager')"> <i
								class="menu-icon fa fa-caret-right"></i> 酒标管理
						</a> <b class="arrow"></b></li>
						<li class=""><a
							href="javascript:clickMenu('labelException')"> <i
								class="menu-icon fa fa-caret-right"></i> 异常酒标
						</a> <b class="arrow"></b></li>
                        <li class=""><a
                                href="javascript:clickMenu('taxCancel')"> <i
                                class="menu-icon fa fa-caret-right"></i> 应税核销
                        </a> <b class="arrow"></b></li>
				</ul></li>
					<li class=""><a href="#" class="dropdown-toggle"> <i
						class="menu-icon fa fa-book"></i> <span class="menu-text"> 监控管理</span>
						<b class="arrow fa fa-angle-down"></b>
						</a> <b class="arrow"></b><!--系统管理的二级菜单-->
					<ul class="submenu">
						<li class="" ><a
							href="javascript:clickMenu('repertory')"> <i
								class="menu-icon fa fa-caret-right"></i> 酒标库存监控
						</a> <b class="arrow"></b></li>
						<li class=""><a
							href="javascript:clickMenu('needTax')"> <i
								class="menu-icon fa fa-caret-right"></i> 酒标应税监控
						</a> <b class="arrow"></b></li>
						<li class=""><a href="javascript:clickMenu('endTax')">
								<i class="menu-icon fa fa-caret-right"></i> 酒标完税监控
						</a> <b class="arrow"></b></li>
						<li class=""><a href="javascript:clickMenu('exceed')">
								<i class="menu-icon fa fa-caret-right"></i> 酒标超期预警
						</a> <b class="arrow"></b></li>
					</ul></li>
					<li class=""><a href="#" class="dropdown-toggle"> <i
					...
					<ul class="submenu">
						 <li class="">
                                    <a href="javascript:clickMenu('org')">
                                ...
                                <li class="">
                                    <a href="javascript:clickMenu('account')">
                                        <i class="menu-icon fa fa-caret-right"></i>
                                        账号管理
                                    </a>
                                    <b class="arrow"></b>
                                ...
                                <li class="">
                                    <a href="javascript:clickMenu('role')">
                                        <i class="menu-icon fa fa-caret-right"></i>
                                        角色管理
                                    </a>
                                    <b class="arrow"></b>
                                ...
                                <li class="">
                                    <a href="javascript:clickMenu('authority')">
                                        <i class="menu-icon fa fa-caret-right"></i>
                                        权限管理
                                    </a>
                                    <b class="arrow"></b>
                                </li>
						<li class="" ><a href="javascript:clickMenu('paramSetting')"> 
    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="menu-content">
                <div id="change-menu">
                    <iframe id="menu-text" width="100%" frameborder="0" src="/views/mainpage/mainpageAcc.jsp"></iframe>
                </div>
            </div>
        </div>
    </div>
